              ...
              <div className="contenedor-beneficios-lista" data-aos="fade-up">
                ...
                <div className="col k p-2">
                  <img
                    ...
                    alt="Go-pharma, MKT MEDIA especializada en el mercado PHARMA y el sector SALUD."
                  />
                  <p className="titulo" data-aos="fade-up">Organización</p>
                ...
                <div className="col k p-2">
                  <img
                    ...
                    alt="Go-pharma, MKT MEDIA especializada en el mercado PHARMA y el sector SALUD."
                  />
                  <p className="titulo" data-aos="fade-up">Constancia</p>
                  <p data-aos="fade-up" className="h4 aos-init aos-animate">Mantenemos el orden y constancia en todo momento.
                  </p>
                </div>
              </div>
            </div>
